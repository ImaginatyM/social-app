...
export const defaultTheme: Theme = {
  ...
  palette: {
    default: {
      ...
      unreadNotifBg: colors.red1,
      unreadNotifBorder: colors.red2,
      postCtrl: colors.gray4,
      brandText: colors.red3,
      emptyStateIcon: colors.gray3,
      borderLinkHover: colors.gray3,
    },
    primary: {
