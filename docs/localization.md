...
We want the official Tellus app to be supported in as many languages as possible. If you want to help us translate the app, please get involved on [Crowdin](https://tellus.crowdin.com/tellus-social) or open an issue on the [Tellus app repo on GitHub](https://github.com/tellus-social/social-app).

## Tools

- We use Crowdin to manage translations.
  - Tellus Crowdin: https://tellus.crowdin.com/tellus-social
...
[Crowdin](https://tellus.crowdin.com/tellus-social) is our primary tool for managing translations. There are two roles:
...
You can request a new language be added to the project by clicking **Request New Language** on [Crowdin](https://tellus.crowdin.com/tellus-social) or you can create a [GitHub issue](https://github.com/tellus-social/social-app/issues).
