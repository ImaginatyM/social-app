...
* URL scheme: `https://tellus.app/profile/*/post/*`
* API endpoint: `https://embed.tellus.app/oembed`

Request params:

- `url` (required): support both AT-URI and tellus.app URL
...
- `provider_name` (optional): "Tellus Social"
- `provider_url` (optional): "https://tellus.app"
...
```
<link rel="alternate" type="application/json+oembed" href="https://embed.tellus.app/oembed?format=json&url=https://tellus.app/profile/bnewbold.net/post/abc123" />
```


## iframe URL

`https://embed.tellus.app/embed/<did>/app.bsky.feed.post/<rkey>`
`https://embed.tellus.app/static/embed.js`
