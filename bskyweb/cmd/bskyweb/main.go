...
func run(args []string) {
	...
	app := cli.App{
		Name:  "bskyweb",
		Usage: "web server for tellus.app web app (SPA)",
	}
		...
		&cli.Command{
			...
			Flags: []cli.Flag{
				...
				&cli.StringSliceFlag{
					...
					Required: false,
					Value:    cli.NewStringSlice("https://tellus.app", "https://main.tellus.dev", "https://app.staging.tellus.dev"),
				...
				&cli.BoolFlag{
					...
					Usage:    "Enable if this is the canonical deployment (tellus.app)",
					Value:    false,
					Required: false,
