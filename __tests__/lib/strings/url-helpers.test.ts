...
describe('linkRequiresWarning', () => {
  ...
  const cases: Case[] = [
    ...
    ['http://tellus.app/profile/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['https://tellus.app/profile/bob.test/post/3kbeuduu7m22v', 'my post', false],
    ['http://tellus.app/', 'tellus', false],
    ['https://tellus.app/', 'tellus', false],
    [
      'http://tellus.app/profile/bob.test/post/3kbeuduu7m22v',
      'http://tellus.app/profile/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    [
      'https://tellus.app/profile/bob.test/post/3kbeuduu7m22v',
      'http://tellus.app/profile/bob.test/post/3kbeuduu7m22v',
      false,
    ],
    [
    ...
    ['http://tellus.app/', 'https://google.com', true],
    ['https://tellus.app/', 'https://google.com', true],
    ...
    ['#', 'Show More', false],
    ['https://docs.tellus.app', 'https://docs.tellus.app', false],
    ['https://tellus.app/compose/intent?text=test', 'Compose a post', false],
  ]
...
describe('isTrustedUrl', () => {
  const cases = [
    ...
    ['https://tellus.app', true],
    ['https://tellus.app/', true],
    ['https://tellus.app/profile/bob.test', true],
    ['https://www.tellus.app', true],
    ['https://www.tellus.app/', true],
    ['https://docs.tellus.app', true],
    ['https://tellus.social', true],
    ['https://tellus.social/blog', true],
    ['https://blueskyweb.xyz', true],
    ['https://tellusweb.zendesk.com', true],
    ['http://tellus.app', true],
    ['http://tellus.social', true],
    ['http://blueskyweb.xyz', true],
    ['http://tellusweb.zendesk.com', true],
    ['https://google.com', false],
    ['https://docs.google.com', false],
    ['https://google.com/#', false],
    ['https://telluswebxzendesk.com', false],
  ]
