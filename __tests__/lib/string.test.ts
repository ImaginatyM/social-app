...
describe('toNiceDomain', () => {
  ...
  const outputs = ['example.com', 'tellus.app', 'Tellus Social', '#123123123']
...
describe('toShortUrl', () => {
  const inputs = [
    'https://tellus.app',
    'https://tellus.app/3jk7x4irgv52r',
    'https://tellus.app/3jk7x4irgv52r2313y182h9',
    'https://very-long-domain-name.com/foo',
    'https://very-long-domain-name.com/foo?bar=baz#andsomemore',
  ]
  const outputs = [
    'tellus.app',
    'tellus.app/3jk7x4irgv52r',
    'tellus.app/3jk7x4irgv52...',
...
describe('toShareUrl', () => {
  const inputs = ['https://tellus.app', '/3jk7x4irgv52r', 'item/test/123']
  const outputs = [
    'https://tellus.app',
    'https://tellus.app/3jk7x4irgv52r',
    'https://tellus.app/item/test/123',
  ]
  ...
  const outputs = [
    {
      type: 'youtube_video',
      source: 'youtube',
      playerUri: 'https://tellus.app/iframe/youtube.html?videoId=videoId&start=0',
    },
    {
      type: 'youtube_video',
      source: 'youtube',
      playerUri: 'https://tellus.app/iframe/youtube.html?videoId=videoId&start=1',
    },
    {
      type: 'youtube_video',
      source: 'youtube',
...
describe('parseStarterPackHttpUri', () => {
  const baseUri = 'https://tellus.app/start'
  ...
  it('returns null when the route is not /start or /starter-pack', () => {
    const validHttpUri = 'https://tellus.app/start/haileyok.com/rkey'
    expect(parseStarterPackUri(validHttpUri)).toEqual({
      name: 'haileyok.com',
      rkey: 'rkey',
    })

    const validHttpUri2 = 'https://tellus.app/starter-pack/haileyok.com/rkey'
    expect(parseStarterPackUri(validHttpUri2)).toEqual({
      name: 'haileyok.com',
      rkey: 'rkey',
    })

    const invalidHttpUri = 'https://tellus.app/profile/haileyok.com/rkey'
